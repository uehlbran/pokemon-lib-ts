...
// Skip test suites when pret reference repositories are not cloned locally.
// The references/ directory is gitignored — CI does not have these files.
// Locally: clone references to run these integration tests.
const gen1Available = fs.existsSync(
  path.join(
    REPO_ROOT,
    "references",
    "pokered-master",
...
const gen2Available = fs.existsSync(
  path.join(
    REPO_ROOT,
    "references",
    "pokecrystal-master",
...
const gen3Available = fs.existsSync(
  path.join(
    REPO_ROOT,
    "references",
    "pokeemerald-master",
...
const gen4Available = fs.existsSync(
  path.join(
    REPO_ROOT,
    "references",
    "pokeplatinum-main",
...
describe.skipIf(!gen1Available)(
  "Gen 1 pret reader — move priority (pokered engine/battle/core.asm)",
  () => {
...
describe.skipIf(!gen1Available)(
  "Gen 1 pret reader — base stats (pokered data/pokemon/base_stats/)",
  () => {
...
describe.skipIf(!gen1Available)(
  "Gen 1 pret reader — type chart (pokered data/types/type_matchups.asm)",
  () => {
    ...
    it("given pokered type_matchups, gen 1 type chart has no steel type", () => {
      ...
      const data = readGen1Data(REPO_ROOT);
      const steelEntry = data.typeChart.find(
        (e) => e.attacker === "steel" || e.defender === "steel",
      );
...
describe.skipIf(!gen2Available)(
  "Gen 2 pret reader — move priority (pokecrystal data/moves/effects_priorities.asm)",
  () => {
...
describe.skipIf(!gen2Available)(
  "Gen 2 pret reader — move data (pokecrystal data/moves/moves.asm)",
  () => {
...
describe.skipIf(!gen2Available)(
  "Gen 2 pret reader — base stats (pokecrystal data/pokemon/base_stats/)",
  () => {
...
describe.skipIf(!gen2Available)(
  "Gen 2 pret reader — type chart (pokecrystal data/types/type_matchups.asm)",
  () => {
...
describe.skipIf(!gen3Available)(
  "Gen 3 pret reader — move priority (pokeemerald src/data/battle_moves.h)",
  () => {
...
describe.skipIf(!gen3Available)(
  "Gen 3 pret reader — move data (pokeemerald src/data/battle_moves.h)",
  () => {
...
describe.skipIf(!gen3Available)(
  "Gen 3 pret reader — base stats (pokeemerald src/data/pokemon/species_info.h)",
  () => {
...
describe.skipIf(!gen3Available)(
  "Gen 3 pret reader — type chart (pokeemerald src/battle_main.c gTypeEffectiveness)",
  () => {
...
describe.skipIf(!gen4Available)(
  "Gen 4 pret reader — move priority (pokeplatinum res/battle/moves/*/data.json)",
  () => {
...
describe.skipIf(!gen4Available)(
  "Gen 4 pret reader — move category (pokeplatinum res/battle/moves/*/data.json)",
  () => {
...
describe.skipIf(!gen4Available)(
  "Gen 4 pret reader — move data (pokeplatinum res/battle/moves/*/data.json)",
  () => {
...
describe.skipIf(!gen4Available)(
  "Gen 4 pret reader — base stats (pokeplatinum res/pokemon/*/data.json)",
  () => {

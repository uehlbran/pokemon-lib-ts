...
description: Advisory PR reviewer for the pokemon-lib-ts monorepo. Posts advisory review comments via gh pr review. Manual use only. AI reviews are advisory only, never formal approvals.
model: sonnet
color: purple

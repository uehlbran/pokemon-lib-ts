...
| 1 | Core ruleset overrides | Pending | -- |
| 2 | Damage calculation | Pending | -- |
| 3 | Terrain system | Pending | -- |
| 4 | Weather + entry hazards | Pending | -- |
| 5A | Abilities: damage + stat | Pending | -- |
| 5B | Abilities: switch + new | Pending | -- |
| 6 | Held items | Pending | -- |
| 7 | Move effects | Pending | -- |
| 8 | Dynamax/Gigantamax gimmick | Pending | -- |
| 9 | Integration + coverage | Pending | -- |
| 10 | Docs + release prep | Pending | -- |

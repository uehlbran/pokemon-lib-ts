...
/**
 * Creates a `DataManager` pre-loaded with complete Gen 5 data:
 * 649 Pokemon, 575 moves, 17-type chart, items, 25 natures,
 * and Gen 5 abilities.
 *
 * Pass the returned instance to `BattleEngine` alongside `Gen5Ruleset`.
 *
 * @returns A `DataManager` instance ready for use with `Gen5Ruleset`.
 */
export function createGen5DataManager(): DataManager {

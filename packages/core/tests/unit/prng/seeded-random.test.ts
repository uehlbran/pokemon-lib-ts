...
const EXPECTED_NEXT_VALUES_FOR_SEED_43 = [
  0.9998110907617956, 0.2764023437630385, 0.5294158514589071, 0.05911232368089259,
  0.06335184047929943,
] as const;
...
const EXPECTED_RESTORED_FUTURE = [
  0.8219508074689656, 0.12997928191907704, 0.9727464164607227, 0.17839484568685293,
  0.7094296528957784,
] as const;

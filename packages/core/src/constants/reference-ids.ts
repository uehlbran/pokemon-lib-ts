...
export const CORE_END_OF_TURN_EFFECT_IDS = {
  ...
  telekinesisCountdown: "telekinesis-countdown",
...
export const CORE_VOLATILE_IDS = {
  aquaRing: "aqua-ring",
  banefulBunker: "baneful-bunker",
  battleBondTransformed: "battle-bond-transformed",
  bound: "bound",
  charged: "charged",
  confusion: "confusion",
  craftyShield: "crafty-shield",
  disable: "disable",
  disguiseBroken: "disguise-broken",
  encore: "encore",
  curse: "curse",
  ...
  hazardStatusSource: "hazard-status-source",
  healBlock: "heal-block",
  ...
  powerTrick: "power-trick",
  powerConstructTransformed: "power-construct-transformed",

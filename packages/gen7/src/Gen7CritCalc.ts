 ...
 */
export const GEN7_CRIT_RATE_TABLE: typeof CRIT_RATE_TABLE_GEN6_PLUS = CRIT_RATE_TABLE_GEN6_PLUS;
 ...
 */
export const GEN7_CRIT_MULTIPLIER: typeof CRIT_MULTIPLIER_MODERN = CRIT_MULTIPLIER_MODERN;

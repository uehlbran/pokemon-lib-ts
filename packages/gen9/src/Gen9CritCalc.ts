 ...
 */
export const GEN9_CRIT_RATE_TABLE = [24, 8, 2, 1] as const;
...
/** @deprecated Use `GEN9_CRIT_RATE_PROBABILITIES`. */
export const GEN9_CRIT_RATES = GEN9_CRIT_RATE_PROBABILITIES;
 ...
 */
export const GEN9_CRIT_MULTIPLIER = 1.5;

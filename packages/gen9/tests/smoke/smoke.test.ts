...
describe("Gen9 smoke tests", () => {
  ...
  it("given createGen9DataManager, when creating DataManager, then can load species", () => {
    // Source: Data generated by tools/data-importer/src/import-gen.ts --gen=9
    // Verify DataManager is functional by checking it can load species data
    const dm = createGen9DataManager();
    expect(dm.getAllSpecies().length).toBeGreaterThan(0);
  });

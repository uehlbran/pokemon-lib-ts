 ...
 * These add +2 to the crit stage.
 * Source: pret/pokecrystal engine/battle/effect_commands.asm L1183-1184 — "inc c; inc c" = +2
 */
...
export function getGen2CritStage(attacker: ActivePokemon, move: MoveData): number {
  ...
  if (move.critRatio && move.critRatio > 0) {
    ...
    // Source: pret/pokecrystal engine/battle/effect_commands.asm lines 1183-1184 —
    //   BattleCommand_Critical: "inc c; inc c" = +2 for CriticalHitMoves
    stage += 2;
  }

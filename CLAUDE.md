...
- **Track review comments until merge** — mandatory. Every review thread must be resolved before merging, and actionable top-level PR comments must have a later author acknowledgment comment that links the specific comment being addressed.

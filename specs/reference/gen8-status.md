...
|-------|----------|---------|
| #687 | #785 | Gen 8 Disguise: non-lethal hits bypassed Disguise; now intercepted via expanded capLethalDamage with 1/8 maxHP chip |
| #725 | #785 | Focus Sash not wired to capLethalDamage; now handled in Gen9Ruleset |

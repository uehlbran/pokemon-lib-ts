...
| #706 | MEDIUM | TBD | Charge move not implemented — should double Electric power next turn via "charged" volatile |
| #705 | MEDIUM | TBD | Mud Sport / Water Sport not implemented — should halve Fire/Electric power |
...
| TBD | fix/gen5-8-bughunt-status | Bughunt wave 2: Charge (doubled Electric power), Mud Sport (halve Electric), Water Sport (halve Fire) (closes #706 #705) |

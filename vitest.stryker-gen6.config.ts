...
// Stryker-specific vitest config for gen6 mutation testing.
  ...
  resolve: {
    alias: [
      ...
      },
      {
        ...
        replacement: fileURLToPath(new URL("./packages/gen5/src/index.ts", import.meta.url)),
      },
      {
        find: "@pokemon-lib-ts/gen6",
        replacement: fileURLToPath(new URL("./packages/gen6/src/index.ts", import.meta.url)),
      },
    ],
  },
  test: {
